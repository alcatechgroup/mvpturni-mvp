...
void main() {
  ...
  test(
    '200 profissional (dono): parse de score/nível/XP/depoimentos',
    () async {
      final svc = service(
        () => ok({
          'papel': 'profissional',
  ...
  test(
    '200 contratante: papel contratante, sem nível/XP, autor anônimo',
    () async {
      final svc = service(
        () => ok({
          'papel': 'contratante',
  ...
  test(
    '200 profissional visto por terceiro: sem chave xp → temXp false',
    () async {
      final svc = service(
        () => ok({
          'papel': 'profissional',
