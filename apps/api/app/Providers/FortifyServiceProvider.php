...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        // Anti-enumeração (CA-7 / ADR-007 §f): sucesso e falha do pedido de link de
        // reset devolvem a MESMA resposta neutra — não revela se o e-mail existe.
        // Em boot() (após o register() do FortifyServiceProvider do pacote) para vencer
        // os bindings default do Fortify.
