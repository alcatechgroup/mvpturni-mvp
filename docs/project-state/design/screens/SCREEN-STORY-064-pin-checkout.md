...
| 2026-06-06 | ajuste consciente pela STORY-065 (§4.11 "polling morto") | claude-opus-4-8 (programador) | em `finalizado`, o DETALHE ganha polling silencioso de 10s enquanto `pix.status == a_caminho` (SCREEN-065 §A.4 — sem isso o "Pix enviado em HH:MM" do CA-4 da 065 não atualiza sem refresh); morre quando o Pix confirma. O polling do CRONÔMETRO segue morto como especificado aqui |
