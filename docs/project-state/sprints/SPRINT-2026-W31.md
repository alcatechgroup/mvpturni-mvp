...
| STORY-095 | Frontend Profissional — banner de disputa + estado em_disputa nas listas                    | EPIC-005 | implementation | programador | S       | ready   |
| STORY-096 | Backoffice Admin — fila + caso com trilha completa + resolver "pagar integral"              | EPIC-005 | implementation | programador | M       | ready   |
